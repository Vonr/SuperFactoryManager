...
class MatchersSection extends FlowContainer {

	protected final FlowDrawer DRAWER;
	protected MovementRuleFlowComponent PARENT;
	private final ItemMatcherSpawnerDrawer ADDER;

	public MatchersSection(MovementRuleFlowComponent parent, Position pos) {
		super(pos);
		PARENT = parent;
		...
		addChild(new SectionHeader(
			new Position(0, 0),
			new Size(35, 12),
			I18n.get("gui.sfm.manager.tile_entity_rule.matchers.title")
		));
