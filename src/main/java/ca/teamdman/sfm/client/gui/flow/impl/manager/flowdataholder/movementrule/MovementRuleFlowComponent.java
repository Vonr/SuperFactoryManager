...
public class MovementRuleFlowComponent extends FlowContainer implements
	FlowDataHolder<ItemMovementRuleFlowData> {

	public final ManagerFlowController CONTROLLER;
	private final TilesSection TILES_SECTION;
	private final MatchersSection MATCHERS_SECTION;
	...
	public MovementRuleFlowComponent(
		...
		MATCHERS_SECTION = new MatchersSection(this, new Position(5, 73));
		addChild(MATCHERS_SECTION);
	...
	public void setData(ItemMovementRuleFlowData data) {
		...
		MATCHERS_SECTION.onDataChanged(data);
