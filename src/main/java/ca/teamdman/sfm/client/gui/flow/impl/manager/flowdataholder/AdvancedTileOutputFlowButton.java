...
public class AdvancedTileOutputFlowButton extends FlowContainer implements
	IFlowCloneable, FlowDataHolder<AdvancedTileOutputFlowData> {

	private final ItemStackTileEntityRuleDrawer DRAWER;
	private final ManagerFlowController CONTROLLER;
	private final FlowIconButton BUTTON;
	private AdvancedTileOutputFlowData data;

	public AdvancedTileOutputFlowButton(
		ManagerFlowController controller,
		AdvancedTileOutputFlowData data
	) {
		this.data = data;
		...
		controller.SCREEN.getFlowDataContainer().addObserver(new FlowDataHolderObserver<>(
			AdvancedTileOutputFlowData.class, this
		));
	}
	...
	public void cloneWithPosition(int x, int y) {
		CONTROLLER.SCREEN.sendFlowDataToServer(
			new AdvancedTileOutputFlowData(
				UUID.randomUUID(),
				new Position(x, y),
	...
	@Override
	public AdvancedTileOutputFlowData getData() {
		return data;
	}

	@Override
	public void setData(AdvancedTileOutputFlowData data) {
		this.data = data;
