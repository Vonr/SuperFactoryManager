...
public abstract class FlowTileTypePicker extends FlowContainer {
	...
	private class SearchResultStack extends ItemStackFlowButton {
		...
		public void onClicked(int mx, int my, int button) {
			// hide after picking
			FlowTileTypePicker.this.setVisible(false);
			FlowTileTypePicker.this.setEnabled(false);
